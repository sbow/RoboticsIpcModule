...
**Active:** `D` — Validation & stress (D0–D1 complete; D2 next)
...
| D | Validation & stress | `[~]` | D0 (per-peer ring sizing, ADR 0009) + D1 (unit suites, self-routing rejection, SourceSeqTracker) done; D2 next |
