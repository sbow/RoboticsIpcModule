...
**Active:** `D` — Validation & stress (D0–D3 complete; D4 next)
...
| D | Validation & stress | `[~]` | D0 (per-peer ring sizing, ADR 0009) + D1 (unit suites, self-routing rejection, SourceSeqTracker) + D2 (4 integration scenarios + D2a per-peer drop attribution) + D3 (soak / leak-check / idle-CPU scripts) done; D4 next |
