...
- [examples/bridges/README.md](../examples/bridges/README.md) — Phase E E3 scaffolding for Phase F bridges (`python_peer` [implemented in F2], `node_gateway` [implemented in F3], `mavlink_gateway` [interface + ADR 0011 in F4], `vision_peer` [F5 sketch])
